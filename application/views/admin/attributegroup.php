    ...
    <div class="modal-dialog modal-sm">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <!-- <p>ADD</p> -->
                <form class="text-center" action="<?= base_url() . 'admin/addattributegroup' ?>" method="post">
    ...
    <div class="modal-dialog modal-sm">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Update Attribute Group</h4>
            </div>
            ...
            <table id="table" class="table">
                <tr>
                    ...
                    ?>
                        ...
                        <th class="text-center"><a href="<?= base_url() . 'admin/attributegroup?sort=' . 'desc' ?>">Name</a><i class="fa-solid fa-chevron-up"></i></th>
                    <?php
                    } else {
                    ?>
                        <th class="text-center"><a href="<?= base_url() . 'admin/attributegroup?sort=' . 'asc' ?>">Name</a><i class="fa-solid fa-chevron-down"></i></th>
                    <?php
                    }
                    ?>
                    <?php
                    ...
                    ?>
                        ...
                        <th class="text-center"><a href="<?= base_url() . 'admin/attributegroup?count=' . 'desc' ?>">Order</a><i class="fa-solid fa-chevron-up"></i></th>
                    <?php
                    } else {
                    ?>
                        <th class="text-center"><a href="<?= base_url() . 'admin/attributegroup?count=' . 'asc' ?>">Order</a><i class="fa-solid fa-chevron-down"></i></th>
                    <?php
                    }
                    ?>
                    <th class="text-center">Action</th>
                </tr>
                <?php foreach ($attributegroup as $ag) : ?>
                    <tr id="<?php echo $ag['id'] ?>">
                        <td><input type="checkbox" id="id" name="id[]" value="<?= $ag['id'] ?>">
                        </td>

                        <td><?= $ag['id'] ?></td>
                        <td><?= $ag['attributename'] ?></td>
                        <td><?= $ag['sortorder'] ?></td>
    ...
    $(document).ready(function() {
        ...
        $("#table").on('click', '.delete', function() {
            ...
            if (confirm('Are you sure to remove this record ?')) {
                $.ajax({
                    url: "<?= base_url() . 'admin/deleteattributegroup' ?>",
                    type: 'POST',
                    data: {
                        id: id
                    },
        ...
        $("#table").on('click', '.edit', function() {
            ...
            var id = $(this).parents("tr").attr("id");
            $.ajax({
                url: "<?= base_url() . 'admin/editattributegroup' ?>",
                type: 'POST',
                data: {
                    id: id
                },
        ...
        $(document).on('submit', '#updateForm', function(e) {
            ...
            $.ajax({
                method: "POST",
                url: "<?= base_url() . 'admin/updateattributegroup' ?>",
                data: {
                    id: id,
                    attname: attname,
                    attorder: attorder
